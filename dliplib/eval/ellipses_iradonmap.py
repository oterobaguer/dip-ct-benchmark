...
from dliplib.reconstructors import iradonmap_reconstructor
...
for size_part in sizes:
    # load reconstructor
    reconstructor = iradonmap_reconstructor('ellipses', size_part, pretrained=True)
    ...
    save_results_table(task_table.results, 'ellipses_iradonmap_eval_100_{}'.format(size_part))

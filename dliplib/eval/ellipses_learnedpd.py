...
for size_part in sizes:
    # load reconstructor
    reconstructor = learnedpd_reconstructor('ellipses', size_part, pretrained=True)
    ...
    save_results_table(task_table.results, 'ellipses_learnedpd_eval_100_{}'.format(size_part))

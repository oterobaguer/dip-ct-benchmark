...
for size_part in sizes:
    # load reconstructor
    reconstructor = learnedpd_reconstructor('lodopab', size_part, pretrained=True)
    ...
    save_results_table(task_table.results, 'lodopab_learnedpd_eval_100_{}'.format(size_part))

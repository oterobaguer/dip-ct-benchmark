...
learnedpd = {'PSNR [db]': [28.09, 28.45, 29.35, 30.11, 30.84, 31.44, 31.84, 32.15, 32.21, 32.27],
             'SSIM': [0.8621, 0.8778, 0.8997, 0.9124, 0.9258, 0.9282, 0.9360, 0.9367, 0.9390, 0.9403]}

learnedgd = {'PSNR [db]': [27.81, 28.40, 29.15, 29.55, 29.70, 29.84, 29.88, 29.95, 30.07, 30.30],
             'SSIM': [0.8580, 0.8769, 0.8955, 0.9027, 0.9051, 0.9077, 0.9082, 0.9094, 0.9121, 0.9162]}

fbpunet = {'PSNR [db]': [26.33, 26.59, 26.8, 27.12, 27.44, 27.97, 28.49, 28.8, 29.1, 29.36],
           'SSIM': [0.7895, 0.8042, 0.8114, 0.8321, 0.8323, 0.8604, 0.8751, 0.8872, 0.894, 0.8987]}

iradonmap = {'PSNR [db]': [17.83, 18.35, 21.41, 22.64, 23.62, 24.77, 25.61, 26.56, 27.36, 28.02],
...
learnedpd_dip = {'PSNR [db]': [29.23, 29.39, 29.85, 30.39, 30.99, 31.44],

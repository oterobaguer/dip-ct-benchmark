...
learnedgd = {'PSNR': [32.70, 33.81, 34.29, 34.34, 34.36],
             'SSIM': [0.7860, 0.8043, 0.8103, 0.8115, 0.8122]}

learnedpd = {'PSNR': [32.68, 34.65, 35.27, 35.63, 35.73],
             'SSIM': [0.7842, 0.8227, 0.8303, 0.8401, 0.8426]}

fbpunet = {'PSNR': [31.33, 33.34, 34.15, 35.35, 35.52],
           'SSIM': [0.7597, 0.8003, 0.8123,  0.8337, 0.8382]}

iradonmap = {'PSNR': [14.82, 17.67, 22.73, 28.69, 30.99],
...
ax[0].set_ylim([22.2, 37.0])
ax[1].set_ylim([0.52, 0.86])
